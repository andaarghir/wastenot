                            ...
                            <form>
                                <div class="row-auth">
                                    ...
                                    <div className="col-field">
                                        <input type = "auth" id="fname" placeholder = "Enter email..." name = "email" className = "form-control"
                                ...
                                <div className="row-auth">
                                    <div className="col-name">
                                        <label className="mb-auth">Enter your password: </label>
                                    </div>
                                    <div className="col-field">
                                        <input className = "password" type = "password" id="fname" placeholder = "Enter password..." name = "password"
                                            //value = {username}
                                ...
                                <div>
                                    ...
                                    <Link to="/" className="btn btn-dark" style={{marginTop:"1px", float: "right"}}><button>Exit</button></Link>
                                </div>
                            </form>
